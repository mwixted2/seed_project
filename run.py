...
while True:
    ...
    if (player and input_state1 and input_state2 and input_state3 and input_state4 and input_state5 and input_state6 and input_state7 and input_state8 and input_state9):
        #os.system('killall omxplayer.bin')
        player = False
